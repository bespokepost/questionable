...
e.g.
  ...
  Assignment.create(question_id: q.id, subject: @product)

or

  Assignment.create(question_id: q.id, subject_type: 'preferences')

===  In your controller

Here's we fetch question-assignments for a particular symbol:

  @assignments = Questionable::Assignment.with_subject(current_user, :preferences)

and here, for a product object:

  @product = Product.find(params[:id])
  @assignments = Questionable::Assignment.with_subject(current_user, @product)
